...
<!-- ========== HOME SECTION ========== -->
<!-- ========== ANIMATED PAGE TITLE ========== -->
<section class="parallax-window" data-parallax="scroll" data-image-src="{{ $bannerImage->getImageUrl() }}" data-speed="0.6" style="padding-bottom: 40px; width: 100%; background-color: rgba(0,0,0,0.64)">
    <div class="container">
