    ...
    <div class="container footer-middle ptn">
        <div class="row">
            <div class="col-md-12 text-center">
                <img src="<?php echo e(asset('frontEnd')); ?>/images/logo-light.png" alt="Salt - HTML5 theme" class="img-responsive mb20" width="100" style="margin: auto;">
            </div>
            <div class="col-md-6">
...
</footer><?php /**PATH D:\programming\OSPanel\OSPanel\domains\turboPush\resources\views/layouts/components/footer.blade.php ENDPATH**/ ?>